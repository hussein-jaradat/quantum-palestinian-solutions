  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        palestine: {
          black: "hsl(var(--palestine-black))",
          white: "hsl(var(--palestine-white))",
          green: "hsl(var(--palestine-green))",
          red: "hsl(var(--palestine-red))",
          gold: "hsl(var(--palestine-gold))",
        },
        weather: {
        ...
        temp: {
          ...
          freezing: "hsl(var(--temp-freezing))",
        },
        alert: {
